...
class MapView(ft.View):
			...
			controls = [
				...
				map.Map(
					...
					configuration=map.MapConfiguration(
						...
						on_secondary_tap=self.handle_tap,
						on_long_press=self.handle_tap,
	...
	def handle_tap(self, e: map.MapTapEvent) -> None:
		print(f"Name: {e.name} - coordinates: {e.coordinates} - Local: ({e.local_x}, {e.local_y}) - Global: ({e.global_x}, {e.global_y})")
		if e.name == "tap":
	...
	def handle_event(self, e: map.MapEvent) -> None:
		print(
